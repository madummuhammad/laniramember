			...
			<div class="user-data-page clearfix d-md-flex">
				...
				<div class="form-wrapper">
					<form action="{{url('registrasi')}}" class="user-data-form mt-50 lg-mt-50" method="POST">
						@csrf
						<h2 class="font-recoleta">Silahkan Mendaftar! </h2>
						<p class="header-info pt-20 pb-20 lg-pb-10">Sudah punya akun? <a href="{{url('login')}}">Registrasi</a></p>
						<div class="row">
							<div class="col-12">
							...
							<div class="col-12">
								<button class="theme-btn-one w-100 mt-30 mb-50">Daftar</button>
							</div>
						</div>
					</form>
				</div> <!-- /.form-wrapper -->
